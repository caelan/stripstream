...
from stripstream.algorithms.utils import BFS, FAST_DOWNWARD, INCREMENTAL, FOCUSED, LAPKT, FAST_FORWARD, PYPLANNERS
...
def main():
    ...
    parser.add_argument('--search', help='problem name.', default=BFS)
